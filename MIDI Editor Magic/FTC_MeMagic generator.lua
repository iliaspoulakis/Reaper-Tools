...
local vmodes = {
    ...
    'scroll to mouse or pitch cursor',
    'scroll to mouse or pitch cursor, restrict to notes in visible area',
    'scroll to mouse or pitch cursor, restrict to notes in item',
